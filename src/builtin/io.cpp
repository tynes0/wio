...
namespace wio
{
    namespace builtin
    {
        ...
        void io::load()
        {
            loader::load_function<1>("Print",       detail::b_print,        { variable_type::vt_any });
            loader::load_function<1>("Println",     detail::b_println,      { variable_type::vt_any });
            loader::load_function<0>("Input",       detail::b_input,        {});
            loader::load_function<2>("OpenFile",    detail::b_open_file,    { variable_type::vt_string, variable_type::vt_integer });
            loader::load_function<1>("CloseFile",   detail::b_close_file,   { variable_type::vt_file });
            loader::load_function<2>("Write",       detail::b_write,        { variable_type::vt_any, variable_type::vt_string });
            loader::load_function<1>("Read",        detail::b_read,         { variable_type::vt_file });
