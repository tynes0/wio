...
namespace wio 
{
    namespace builtin 
    {
        namespace detail 
        {
            ...
            {
                auto ref_0 = make_ref<variable>(any(float_t(0.0)), variable_type::vt_float);
        ...
        static void load_all(symbol_map& table)
        {
            ...
            loader::load_function(table, "Abs", detail::b_abs, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Sin", detail::b_sin, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Cos", detail::b_cos, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Tan", detail::b_tan, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Sqrt", detail::b_sqrt, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Pow", detail::b_pow, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Log", detail::b_log, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Log10", detail::b_log10, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcSin", detail::b_asin, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcCos", detail::b_acos, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcTan", detail::b_atan, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Ceil", detail::b_ceil, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Floor", detail::b_floor, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Round", detail::b_round, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Exp", detail::b_exp, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcTan2", detail::b_atan2, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Fmod", detail::b_fmod, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Sinh", detail::b_sinh, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Cosh", detail::b_cosh, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Tanh", detail::b_tanh, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcSinh", detail::b_asinh, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcCosh", detail::b_acosh, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ArcTanh", detail::b_atanh, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Root", detail::b_root, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "LogBase", detail::b_log_base, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Min", detail::b_min, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Max", detail::b_max, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "ToRadians", detail::b_to_radians, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "ToDegrees", detail::b_to_degrees, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Random", detail::b_random, pa<0>{ });
            loader::load_function(table, "FRandom", detail::b_frandom, pa<0>{ });
            loader::load_function(table, "RandomInRange", detail::b_random_in_range, pa<2>{ variable_base_type::variable, variable_base_type::variable });

            auto vec2_result = loader::load_function(table, "Vec2", detail::b_vec2, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_overload(vec2_result, detail::b_vec2_2, pa<1>{ variable_base_type::variable });
            loader::load_overload(vec2_result, detail::b_vec2_3, pa<0>{});

            auto vec3_result = loader::load_function(table, "Vec3", detail::b_vec3, pa<3>{ variable_base_type::variable, variable_base_type::variable, variable_base_type::variable });
            loader::load_overload(vec3_result, detail::b_vec3_2, pa<1>{ variable_base_type::variable });
            loader::load_overload(vec3_result, detail::b_vec3_3, pa<2>{ variable_base_type::variable, variable_base_type::variable });
