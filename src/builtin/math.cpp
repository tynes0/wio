...
namespace wio 
{
    namespace builtin 
    {
        ...
        {
            loader::load_function<1>(target_scope, "Abs", detail::b_abs, variable_type::vt_var_param, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Sin", detail::b_sin, variable_type::vt_float, { variable_type::vt_float });
            loader::load_function<1>(target_scope, "Cos", detail::b_cos, variable_type::vt_float, { variable_type::vt_float });
            loader::load_function<1>(target_scope, "Tan", detail::b_tan, variable_type::vt_float, { variable_type::vt_float });
            loader::load_function<1>(target_scope, "Sqrt", detail::b_sqrt, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "Pow", detail::b_pow, variable_type::vt_var_param, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Log", detail::b_log, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Log10", detail::b_log10, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "ArcSin", detail::b_asin, variable_type::vt_float, { variable_type::vt_float });
            loader::load_function<1>(target_scope, "ArcCos", detail::b_acos, variable_type::vt_float, { variable_type::vt_float });
            loader::load_function<1>(target_scope, "ArcTan", detail::b_atan, variable_type::vt_float, { variable_type::vt_float });
            loader::load_function<1>(target_scope, "Ceil", detail::b_ceil, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Floor", detail::b_floor, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Round", detail::b_round, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Exp", detail::b_exp, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "ArcTan2", detail::b_atan2, variable_type::vt_float, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "Fmod", detail::b_fmod, variable_type::vt_float, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Sinh", detail::b_sinh, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Cosh", detail::b_cosh, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "Tanh", detail::b_tanh, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "ArcSinh", detail::b_asinh, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "ArcCosh", detail::b_acosh, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<1>(target_scope, "ArcTanh", detail::b_atanh, variable_type::vt_float, { variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "Root", detail::b_root, variable_type::vt_float, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "LogBase", detail::b_log_base, variable_type::vt_float, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "Min", detail::b_min, variable_type::vt_var_param, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>(target_scope, "Max", detail::b_max, variable_type::vt_var_param, { variable_type::vt_var_param, variable_type::vt_var_param });
