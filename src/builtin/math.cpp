...
namespace wio 
{
    namespace builtin 
    {
        ...
        void math::load()
        {
            loader::load_function<1>("Abs",     detail::b_abs,      { variable_type::vt_var_param });
            loader::load_function<1>("Sin",     detail::b_sin,      { variable_type::vt_float });
            loader::load_function<1>("Cos",     detail::b_cos,      { variable_type::vt_float });
            loader::load_function<1>("Tan",     detail::b_tan,      { variable_type::vt_float });
            loader::load_function<1>("Sqrt",    detail::b_sqrt,     { variable_type::vt_var_param });
            loader::load_function<2>("Pow",     detail::b_pow,      { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<1>("Log",     detail::b_log,      { variable_type::vt_var_param });
            loader::load_function<1>("Log10",   detail::b_log10,    { variable_type::vt_var_param });
            loader::load_function<1>("ArcSin",  detail::b_asin,     { variable_type::vt_float });
            loader::load_function<1>("ArcCos",  detail::b_acos,     { variable_type::vt_float });
            loader::load_function<1>("ArcTan",  detail::b_atan,     { variable_type::vt_float });
            loader::load_function<1>("Ceil",    detail::b_ceil,     { variable_type::vt_var_param });
            loader::load_function<1>("Floor",   detail::b_floor,    { variable_type::vt_var_param });
            loader::load_function<1>("Round",   detail::b_round,    { variable_type::vt_var_param });
            loader::load_function<1>("Exp",     detail::b_exp,      { variable_type::vt_var_param });
            loader::load_function<2>("ArcTan2", detail::b_atan2,    { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>("Fmod",    detail::b_fmod,     { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<1>("Sinh",    detail::b_sinh,     { variable_type::vt_var_param });
            loader::load_function<1>("Cosh",    detail::b_cosh,     { variable_type::vt_var_param });
            loader::load_function<1>("Tanh",    detail::b_tanh,     { variable_type::vt_var_param });
            loader::load_function<1>("ArcSinh", detail::b_asinh,    { variable_type::vt_var_param });
            loader::load_function<1>("ArcCosh", detail::b_acosh,    { variable_type::vt_var_param });
            loader::load_function<1>("ArcTanh", detail::b_atanh,    { variable_type::vt_var_param });
            loader::load_function<2>("Root",    detail::b_root,     { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>("LogBase", detail::b_log_base, { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>("Min",     detail::b_min,      { variable_type::vt_var_param, variable_type::vt_var_param });
            loader::load_function<2>("Max",     detail::b_max,      { variable_type::vt_var_param, variable_type::vt_var_param });
