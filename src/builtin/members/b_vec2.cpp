...
namespace wio
{
    namespace builtin
    {
        namespace detail
        {
            ...
            {
                vec2& vec_var = get_vec2(args[0]);
                float_t rad = helper::var_as_float(args[1]);
        ...
        ref<symbol_table> b_vec2::load()
        {
            ...
            loader::load_function(table, "MagnitudeSquared", detail::b_vec2_magnitude_squared, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Dot", detail::b_vec2_dot, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Cross", detail::b_vec2_cross, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "DistanceSquared", detail::b_vec2_distance_squared, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Magnitude", detail::b_vec2_magnitude, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Distance", detail::b_vec2_distance, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Angle", detail::b_vec2_angle, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Normalize", detail::b_vec2_normalize, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Normalized", detail::b_vec2_normalized, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Rotate", detail::b_vec2_rotate, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Rotated", detail::b_vec2_rotated, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Lerp", detail::b_vec2_lerp, pa<3>{ variable_base_type::variable, variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Clamp", detail::b_vec2_clamp, pa<3>{ variable_base_type::variable, variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Abs", detail::b_vec2_abs, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Floor", detail::b_vec2_floor, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Ceil", detail::b_vec2_ceil, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Round", detail::b_vec2_round, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "Project", detail::b_vec2_project, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Reflect", detail::b_vec2_reflect, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_function(table, "Round", detail::b_vec2_round, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "IsOneOfZero", detail::b_vec2_is_one_of_zero, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "IsZero", detail::b_vec2_is_zero, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "IsNan", detail::b_vec2_is_nan, pa<1>{ variable_base_type::variable });
            loader::load_function(table, "IsInfinite", detail::b_vec2_is_inf, pa<1>{ variable_base_type::variable });

            auto equals_func = loader::load_function(table, "Equals", detail::b_vec2_equals, pa<2>{ variable_base_type::variable, variable_base_type::variable });
            loader::load_overload(equals_func, detail::b_vec2_equals_2, pa<3>{ variable_base_type::variable, variable_base_type::variable, variable_base_type::variable });
