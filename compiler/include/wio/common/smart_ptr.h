...
struct std::hash<wio::common::Ref<T>>
{
    [[nodiscard]] std::size_t operator()(const wio::common::Ref<T>& ref) const noexcept
    {
...
namespace wio
{
    using common::RefCountedObject;
    using common::Ref;
    using common::WeakRef;
}
