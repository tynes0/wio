...
namespace wio::wir::typed
{
    ...
    {
        return opcode == Opcode::Return || opcode == Opcode::Branch || opcode == Opcode::CondBranch ||
    ...
    bool producesValue(const Opcode opcode)
    {
        return opcode == Opcode::Constant || opcode == Opcode::GenericConstant || opcode == Opcode::DefaultValue ||
               ...
               opcode == Opcode::Convert || opcode == Opcode::Call || opcode == Opcode::NativeCall ||
               ...
               opcode == Opcode::ResultUnwrap || opcode == Opcode::Await || opcode == Opcode::GlobalPlace ||
               ...
               opcode == Opcode::ConstructObject || opcode == Opcode::Copy || opcode == Opcode::Move ||
    ...
    std::string_view conversionKindName(const ConversionKind kind)
    {
        switch (kind)
        {
        case ConversionKind::NumericWiden:
            return "numeric-widen";
        case ConversionKind::NumericFit:
            return "numeric-fit";
        }
        return "unknown";
    }
    ...
    std::string_view borrowLifetimeName(const BorrowLifetime lifetime)
    {
        switch (lifetime)
        {
        case BorrowLifetime::None:
            return "none";
        case BorrowLifetime::Caller:
            return "caller";
        case BorrowLifetime::Lexical:
            return "lexical";
        }
        return "none";
    }
