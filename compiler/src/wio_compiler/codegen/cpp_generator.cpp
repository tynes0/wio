...
namespace wio::codegen
{
    namespace 
    {
        ...
        #include "detail/backend_type_queries.inl"

        #include "detail/generic_codegen.inl"
        ...
        #include "detail/module_export_index.inl"

        #include "detail/sdk_dynamic_bridge.inl"

        #include "detail/named_type_mangling.inl"

    #include "detail/generator_core.inl"

    #include "detail/module_api_emitter.inl"
