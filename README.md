...
The generated package installer can optionally persist `WIO_ROOT` and
`WIO_HOME` for the current user, but the packaged compiler still works without
them thanks to executable-relative toolchain discovery.
