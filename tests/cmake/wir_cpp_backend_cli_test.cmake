...
if(NOT compile_result EQUAL 0)
    message(FATAL_ERROR
        "Default WIR C++ backend compile failed (${compile_result})\n${compile_stdout}\n${compile_stderr}")
endif()
if(NOT EXISTS "${output}")
    message(FATAL_ERROR "Default WIR C++ backend did not create ${output}")
endif()

execute_process(COMMAND "${output}" RESULT_VARIABLE run_result)
if(NOT run_result EQUAL 3)
    message(FATAL_ERROR "Default WIR C++ backend program returned ${run_result}; expected 3")
endif()
