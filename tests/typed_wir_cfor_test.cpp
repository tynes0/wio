...
int main()
{
    ...
    ok &= expect(typedText.find("\"for.header\"") != std::string::npos &&
                     ...
                     typedText.find("load") != std::string::npos && typedText.find("store") != std::string::npos,
                 "Typed WIR must expose canonical C-style for regions and explicit place mutation");
    ...
    ok &= expect(loweredText.find("\"for.increment\"") != std::string::npos &&
